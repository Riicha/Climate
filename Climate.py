...
# Query for the dates and temperature observations from last year. 
# Convert the query result to a dictionary using date as the key and tobs as the value. 
...
def stations():    
    ...
    station_List = []
    for stn in stations:
        station_List.append({"station":s[0],"name":stn[1]})
